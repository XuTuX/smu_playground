...
세명대학교 학과 대항 미니게임 행사용 Next.js 웹사이트입니다. 관리자가 학번, 학과, 닉네임 또는 팀명, 게임, 점수를 입력하면 Supabase에 저장되고 공개 랭킹에 반영됩니다.
...
4. 팀전은 대표자 닉네임과 팀명을 분리해 입력하고, 개인전은 학생 닉네임을 사용합니다.
5. 게임과 점수를 선택해 등록합니다.
6. 같은 학번·게임의 기록이 이미 있으면 더 높은 점수만 반영됩니다.
