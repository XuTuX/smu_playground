  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-6 gap-2.5 sm:gap-4 items-stretch">
        {/* Left Indicator Card */}
        <div className="md:col-span-2 bg-white border border-stone-200/90 rounded-3xl p-4 sm:p-6 shadow-sm flex items-center gap-3 sm:gap-4">
          ...
          {games.map((game) => {
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center justify-between p-3 sm:p-4 rounded-2xl border ${theme.border} ${theme.bg} transition-all duration-150 hover:-translate-y-1 hover:shadow-md text-center group`}
